                ...
                <div class="team-info">
                    <div class="head-info">
                        <div class="logo">
                            ...
                            @else
                                <img src="{{Storage::url('images/teams/'.$team['team_logo'])}}" height="50px;" alt="">
                    ...
                    @foreach($matchFuture as $match)
                        <div class="card-match">
                            <div class="team">
                                ...
                                @else
                                    <img src="{{Storage::url('images/teams/'.$match['home_team_logo'])}}" height="50px;" alt="">
                                @endif
                            </div>
                            <div class="score">
                            ...
                            <div class="team">
                                ...
                                @else
                                    <img src="{{Storage::url('images/teams/'.$match['enemy_team_logo'])}}" height="50px;" alt="">
                    ...
                    @foreach($team['players'] as $player)
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <div class="card-player">
                                <div class="img-wrapper" style="background-image: url({{ Storage::url('images/players/'.$player['photo']) }}); background-position: center; background-repeat: no-repeat; background-size: cover;"></div>
