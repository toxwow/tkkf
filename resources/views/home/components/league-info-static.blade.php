                ...
                <div class="card-wrapper">
                    <div class="title-card">
                        ...
                        <div class="league-items">
                            <a style="cursor: pointer" class="active" id="league-1">I Liga</a>
                            <a style="cursor: pointer"  id="league-2">II Liga</a>
                            <a style="cursor: pointer"  id="league-3">III Liga</a>
                            <a style="cursor: pointer"  id="league-4">IV Liga</a>
                            <a style="cursor: pointer"  id="league-5">V Liga</a>
                            <a style="cursor: pointer"  id="league-6">Liga Kobiet</a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-5 order-lg-2">
                            <div class="table-teams">
                                ...
                                <div class="table-teams-wrapper" id="league-2">
                                    <table class="table">
                                        <thead>
                                        <tr>
                                            <th scope="col"></th>
                                ...
                                <div class="table-teams-wrapper" id="league-3">
                                    <table class="table">
                                        <thead>
                                        <tr>
                                            <th scope="col"></th>
                                ...
                                <div class="table-teams-wrapper" id="league-4">
                                    <table class="table">
                                        <thead>
                                        <tr>
                                            <th scope="col"></th>
                                ...
                                <div class="table-teams-wrapper" id="league-5">
                                    <table class="table">
                                        <thead>
                                        <tr>
                                            <th scope="col"></th>
                                ...
                                <div class="table-teams-wrapper" id="league-6">
                                    <table class="table">
                                        <thead>
                                        <tr>
                                            <th scope="col"></th>
